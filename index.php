...
<body class="h-screen overflow-x-hidden" style="background: #edf2f7;">
  ...
  <div class="bg-gray-100 font-sans w-full min-h-screen">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="block sm:hidden bg-white border-t-2 py-2">
          <div class="flex flex-col">
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-red-600 mb-1">Products</a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-red-600 mb-1">Marketplace</a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-red-600 mb-1">Partners</a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-red-600 mb-1">Pricing</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="p-24 flex flex-wrap items-center justify-center">
        ...
        <!-- product one -->
        <div class="flex-shrink-0 m-6 relative overflow-hidden bg-red-600 rounded-lg max-w-xs shadow-lg">
          <svg class="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none" style="transform: scale(1.5); opacity: 0.1;">
            <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
            <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white"/>
          </svg>
