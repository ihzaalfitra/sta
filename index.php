...
<body class="h-screen overflow-x-hidden flex items-center justify-center" style="background: #edf2f7;">

  <!-- navbar -->
  <div class="bg-gray-100 font-sans w-full min-h-screen mt-56">
